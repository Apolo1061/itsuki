...
Itsuki incluye un formateador de código integrado para mantener tu proyecto limpio y legible.
```powershell
./itsuki fmt <archivo.suki>
```
Este comando ajustará automáticamente la indentación basándose en los niveles de llaves `{}`.
