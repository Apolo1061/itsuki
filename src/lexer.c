...
Token next_tk(Lexer* l) {
    ...
    if (isalpha(c) || c == '_') {
        ...
        if (!strcmp(b, "funcion")) return (Token){TOKEN_FUNCION, my_strdup(b), ln};
        if (!strcmp(b, "importar")) return (Token){TOKEN_IMPORTAR, my_strdup(b), ln};
        if (!strcmp(b, "exportar")) return (Token){TOKEN_EXPORTAR, my_strdup(b), ln};
        if (!strcmp(b, "desde")) return (Token){TOKEN_DESDE, my_strdup(b), ln};
        if (!strcmp(b, "como")) return (Token){TOKEN_COMO, my_strdup(b), ln};
        if (!strcmp(b, "retornar")) return (Token){TOKEN_RETORNAR, my_strdup(b), ln};
        ...
        if (!strcmp(b, "si")) return (Token){TOKEN_SI, my_strdup(b), ln};
        if (!strcmp(b, "sino")) return (Token){TOKEN_SINO, my_strdup(b), ln};
        if (!strcmp(b, "mientras")) return (Token){TOKEN_MIENTRAS, my_strdup(b), ln};
        if (!strcmp(b, "para")) return (Token){TOKEN_PARA, my_strdup(b), ln};
        if (!strcmp(b, "en")) return (Token){TOKEN_EN, my_strdup(b), ln};
        if (!strcmp(b, "romper")) return (Token){TOKEN_ROMPER, my_strdup(b), ln};
        if (!strcmp(b, "continuar")) return (Token){TOKEN_CONTINUAR, my_strdup(b), ln};
        ...
        if (!strcmp(b, "intentar")) return (Token){TOKEN_INTENTAR, my_strdup(b), ln};
        if (!strcmp(b, "capturar")) return (Token){TOKEN_CAPTURAR, my_strdup(b), ln};
        if (!strcmp(b, "finalmente")) return (Token){TOKEN_FINALMENTE, my_strdup(b), ln};
        if (!strcmp(b, "lanzar")) return (Token){TOKEN_LANZAR, my_strdup(b), ln};
        if (!strcmp(b, "clase")) return (Token){TOKEN_CLASE, my_strdup(b), ln};
        if (!strcmp(b, "nueva")) return (Token){TOKEN_NUEVA, my_strdup(b), ln};
        if (!strcmp(b, "hereda")) return (Token){TOKEN_HEREDA, my_strdup(b), ln};
        if (!strcmp(b, "estatico")) return (Token){TOKEN_ESTATICO, my_strdup(b), ln};
        if (!strcmp(b, "privado")) return (Token){TOKEN_PRIVADO, my_strdup(b), ln};
        if (!strcmp(b, "publico")) return (Token){TOKEN_PUBLICO, my_strdup(b), ln};
        if (!strcmp(b, "super")) return (Token){TOKEN_SUPER, my_strdup(b), ln};
        if (!strcmp(b, "lambda")) return (Token){TOKEN_LAMBDA, my_strdup(b), ln};
        if (!strcmp(b, "nulo")) return (Token){TOKEN_NULO, my_strdup(b), ln};
        if (!strcmp(b, "enum")) return (Token){TOKEN_ENUM, my_strdup(b), ln};
        if (!strcmp(b, "caso")) return (Token){TOKEN_CASO, my_strdup(b), ln};
        if (!strcmp(b, "es")) return (Token){TOKEN_ES, my_strdup(b), ln};
